...
- **The first time a cost or a price appears, the account comes before the options**, never only inside the options or the summary: three lines at most, in this order — the priciest ingredient ("Arroz: R$ 24,90 ÷ 5 kg = R$ 4,98/kg → usa 400 g = R$ 1,99"), the dish ("R$ 17,90 ÷ 10 porções = R$ 1,79 por porção") and the minimum price ("R$ 1,79 ÷ 0,90 = R$ 1,99, porque o iFood fica com 10%"). Only then the clarify, whose options carry the price and the profit alone. The launch menu keeps the same rule: the price line says where the profit came from.
