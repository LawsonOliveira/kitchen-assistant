...
- **A question that shows a price, a cost or a promotion carries the account that led to it**, inside the question itself — it is the message she reads at that moment, and a result alone teaches her nothing: "O prato deu R$ 17,90 ÷ 10 porções = R$ 1,79 por porção; o mínimo é R$ 1,79 ÷ 0,90 = R$ 1,99, porque o iFood fica com 10%. Qual preço a senhora quer fixar?", "R$ 9,90 − 15% = R$ 8,42, lucro R$ 4,86 por porção. Faço a promoção?". The options then carry only the price and the profit, and the launch menu says where the profit came from.
