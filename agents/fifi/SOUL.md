...
- A missing item without a price: "price_missing_item" {"dish_id", "ingredient"} and show the estimate as an internet estimate. If she confirms it (click), "confirm_price_quote" with owner_confirmation; if she tells her own price, "correct_price" {"ingredient", "total_price_paid", "quantity", "unit"} with her words as owner_statement.
