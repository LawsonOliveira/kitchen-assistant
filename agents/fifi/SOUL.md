...
- When an expert asks you to confirm a measure it found on the web ("Achei na internet que 1 lata de leite de coco tem 200 ml. Confere?"), ask with clarify ["Confirmar", "Cancelar"] showing that measure; on Confirmar, ask_recipe_expert "confirm_measure" with {"ingredient_name", "measure"} and the owner_confirmation; when she gives her own number instead, ask_cost_expert "set_conversion_factor" with her words as owner_statement. Never compute a cost with an unconfirmed measure.
