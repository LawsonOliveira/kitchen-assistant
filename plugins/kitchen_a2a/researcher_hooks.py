...
def transform_tool_result(tool_name: str = "", args: dict | None = None, result=None, session_id: str = "", **_):
    ...
    if tool_name not in ("web_search", "web_extract"):
        return None
    fixtures_dir = os.environ.get("KITCHEN_WEB_FIXTURES_DIR")
...
def register(ctx) -> None:
    ...
    ctx.register_tool(name="fan_out_research", toolset="kitchen_a2a", handler=fan_out_research, description=TOOL_DESCRIPTION,
